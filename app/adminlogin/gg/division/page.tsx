...
import DivisionDelegatesTable from "@/app/gg/division/[divisionName]/DIvisionDeligates";

export default function GGAdminDivisionPage() {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-indigo-700">
            Grand Gathering — Division Delegates
          </h1>
