...
import GrandGatheringSectorList from "@/app/components/GrandGatheringSectorList";

export default function GGAdminSectorPage() {
    ...
    <main className="space-y-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-indigo-700 mb-8">
          Grand Gathering Delegates — Sector Wise Data
        </h1>
        ...
        {divisionName ? (
          <GrandGatheringSectorList divisionName={divisionName} />
        ) : (
          !loading && (
