        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={itemAnim} className="">
              <span className="text-xs sm:text-sm font-medium uppercase -ms-42 sm:ms-0 tracking-widest text-purple-700 mb-2">
                SSF Kozhikode South
              </span>
            </motion.div>
            ...
            <motion.div variants={itemAnim} className="mb-2 sm:mb-4 flex justify-center lg:justify-start">
              <img
                ...
                className="h-45 sm:h-75 md:h-80 w-auto max-w-full object-contain drop-shadow-sm"
              />
            </motion.div>

            <motion.p
              variants={itemAnim}
              className="text-xs sm:text-base hidden md:block lg:text-lg text-slate-600 max-w-xl font-normal leading-snug sm:leading-relaxed mb-3 sm:mb-4 px-1 sm:px-0"
            >
            ...
            <motion.div
              variants={itemAnim}
              className="w-full max-w-xl my-4 sm:my-6 p-4 sm:p-5 rounded-3xl bg-white/90 border border-purple-200/90 backdrop-blur-md shadow-sm divide-y divide-purple-100 space-y-3.5"
            >
              {/* Date & Time Row */}
              <div className="flex items-center gap-3.5 sm:gap-4">
                <div className="p-2.5 sm:p-3 rounded-2xl bg-purple-100 text-purple-700 shrink-0">
                  <Calendar className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-left min-w-0 flex-1">
                  <p className="text-xs sm:text-sm text-purple-700 font-medium uppercase tracking-wider">Date & Time</p>
                  <p className="text-base sm:text-lg font-medium text-slate-900 truncate">
                    Sep 10, 2026 • 5:30 PM
                  </p>
                  <p className="text-xs text-amber-600 font-normal">Thursday Evening</p>
                </div>
              </div>

              {/* Venue Row */}
              <div className="flex items-center gap-3.5 sm:gap-4 pt-3.5">
                <div className="p-2.5 sm:p-3 rounded-2xl bg-amber-100 text-amber-700 shrink-0">
                  <MapPin className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-left min-w-0 flex-1">
                  <p className="text-xs sm:text-sm text-amber-700 font-medium uppercase tracking-wider">Venue</p>
                  <p className="text-base sm:text-lg font-medium text-slate-900 truncate">
