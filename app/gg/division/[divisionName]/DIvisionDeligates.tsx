...
export default function DivisionDelegatesTable({
  ...
  const shareFullListToWhatsApp = () => {
    ...
    let text = `*Grand Gathering — ${divisionName} Division Delegates*\n📊 *Total Delegates:* ${filtered.length}`;
    if (attendanceMode) {
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold shadow-md transition active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
