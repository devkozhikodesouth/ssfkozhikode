                ...
                <table className="min-w-full border border-gray-200 rounded-lg">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left font-semibold text-gray-700 w-32">Designation</th>
                      <th className="px-4 py-3 text-left font-semibold text-gray-700 w-32">Ticket</th>
                      <th className="px-4 py-3 text-left font-semibold text-gray-700 w-32">Division</th>
