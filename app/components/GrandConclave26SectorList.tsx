...
export default function GrandConclave26SectorList({
  ...
  const shareFullDivisionListToWhatsApp = () => {
    ...
    let text = `*Grand Conclave 26 — ${data.divisionName} Division Sector Data*\n📊 *Total Delegates:* ${data.totalStudents}`;
    if (attendanceMode) {
      ...
      <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-4 py-2 rounded-xl shadow transition text-sm active:scale-95 cursor-pointer"
          >
          ...
          <button
            onClick={handleSort}
            className="flex items-center gap-2 bg-indigo-600 text-white font-medium px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition text-sm cursor-pointer"
          >
                ...
                <div className="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-lg font-semibold">
                  ...
                  <div className="flex items-center gap-4 text-sm font-bold">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                    >
                          ...
                          >
                            ...
                            <td className="px-3 py-2 text-center">
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-sm transition active:scale-95 cursor-pointer"
                              >
                                <Share2 className="w-3.5 h-3.5" />
                                <span>WhatsApp</span>
                              </button>
